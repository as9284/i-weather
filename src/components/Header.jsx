    ...
    <>
      <div className="w-full h-[10vh] md:h-[7vh] bg-neutral-900 flex justify-between items-center px-4 select-none z-20 text-center">
        <div className="h-full flex justify-center items-center gap-1">
          ...
          <h1 className="text-lg md:text-xl font-bold">iWeather</h1>
        </div>
        <div className="hidden h-full md:flex justify-center items-center font-bold">
          {currentTime}
        </div>
        <button className="w-20 h-full font-bold">About</button>
      </div>
    </>
  );
};
